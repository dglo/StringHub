...
public class LeadingEdgeRAPCal extends AbstractRAPCal
{
    ...
    private static final Logger logger = 
        Logger.getLogger(LeadingEdgeRAPCal.class);

    public LeadingEdgeRAPCal()
    {
        super();
        threshold = Double.parseDouble(System.getProperty(
            "icecube.daq.rapcal.LeadingEdgeRAPCal.threshold", "100.0"));
    }

    /**
     * Calculate fine time correction to TCAL rough timestamp 
     * by using interpolated leading edge crossing of a threshold.
     * @param w input RAPCal waveform
     * @return leading edge correction to the RAPCal waveform 
     * in units of seconds.
     * @throws RAPCalException when something goes wrong with 
     * the edge detection
     */
    @Override
