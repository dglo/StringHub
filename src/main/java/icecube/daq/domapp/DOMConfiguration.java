...
public class DOMConfiguration implements Serializable
{
    ...
    private LocalCoincidenceConfiguration lc = 
    ...
    public void disableMinBias() 
    {
        enableMinBias = false; 
    }
    
    /**
     * Disable readout of the supernova scalers.  Normally, 
     ...
     */
    public void enableDeltaCompression() 
    { 
        compressionEnabled = true; 
    }

    public void enableMinBias() 
    { 
        enableMinBias = true; 
    }
    /**
    ...
    public AtwdChipSelect getAtwdChipSelect() 
    { 
        return atwdSelect; 
    }
    ...
    public EngineeringRecordFormat getEngineeringFormat() 
    {
        return engFormat; 
    }
    ...
    public LocalCoincidenceConfiguration getLC() 
    {
        return lc; 
    }

    public MuxState getMux() 
    { 
        return mux; 
    ...
    public boolean isDeltaCompressionEnabled() 
    {
    ...
    public boolean isMinBiasEnabled()
    {
        return enableMinBias; 
    }
    ...
    public boolean isSupernovaEnabled() 
    { 
        return supernovaEnabled; 
    }
    ...
    public void setAtwdChipSelect(AtwdChipSelect cs) 
    { 
        atwdSelect = cs; 
    }
    ...
    public void setHistoInterval(int interval) 
    { 
        histoInterval = interval; 
    }
    
    public void setHistoPrescale(short prescale) 
    {
        histoPrescale = prescale; 
    }
