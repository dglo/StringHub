...
public class EngineeringRecordFormat implements Serializable 
{
    ...
    public EngineeringRecordFormat(short fadc_samples, short[] atwd_samples, 
        short[] atwd_size) throws BadEngineeringFormat 
    {
    ...
    public EngineeringRecordFormat(short fadc_samples) 
        throws BadEngineeringFormat 
    {
     ...
     * @param copyFrom the object whose values will be copied into 
     *  the new instance
     */
    ...
    private int atwdPackedFormat(int size, int samples) 
        throws BadEngineeringFormat 
    {
        int nybble = 1;
        if (size == 2) {
        ...
        case 128:     
            return nybble | 12;
        default:    
            throw new BadEngineeringFormat(size, samples);
        }
    }
