        ...
        if (localName.equals("triggerMode")) {
            ...
            if (localName.equals("source")) {
                ...
                if (text.equals("auto")) {
                    ...
                    currentConfig.setChargeStampAtwdChannel(
                        Byte.parseByte(text));
                }
            ...
            if (localName.equals("type")) {
                if (text.equals("soft")) {
                    currentConfig.getLC().setType(
                        LocalCoincidenceConfiguration.Type.SOFT);
                } else if (text.equals("hard")) {
                    currentConfig.getLC().setType(
                        LocalCoincidenceConfiguration.Type.HARD);
                }
            } else if (localName.equals("mode")) {
                if (text.equals("none")) {
                    currentConfig.getLC().setRxMode(
                        LocalCoincidenceConfiguration.RxMode.RXNONE);
                } else if (text.equals("up-or-down")) {
                    currentConfig.getLC().setRxMode(
                        LocalCoincidenceConfiguration.RxMode.RXEITHER);
                } else if (text.equals("up")) {
                    currentConfig.getLC().setRxMode(
                        LocalCoincidenceConfiguration.RxMode.RXUP);
                } else if (text.equals("down")) {
                    currentConfig.getLC().setRxMode(
                        LocalCoincidenceConfiguration.RxMode.RXDOWN);
                } else if (text.equals("up-and-down")) {
                    currentConfig.getLC().setRxMode(
                        LocalCoincidenceConfiguration.RxMode.RXBOTH);
                } else if (text.equals("headers-only")) {
                    currentConfig.getLC().setRxMode(
                        LocalCoincidenceConfiguration.RxMode.RXHDRS);
                }
            } else if (localName.equals("txMode")) {
                if (text.equals("none")) {
                    currentConfig.getLC().setTxMode(
                        LocalCoincidenceConfiguration.TxMode.TXNONE);
                } else if (text.equals("both")) {
                    currentConfig.getLC().setTxMode(
                        LocalCoincidenceConfiguration.TxMode.TXBOTH);
                } else if (text.equals("up")) {
                    currentConfig.getLC().setTxMode(
                        LocalCoincidenceConfiguration.TxMode.TXUP);
                } else if (text.equals("down")) {
                    currentConfig.getLC().setTxMode(
                        LocalCoincidenceConfiguration.TxMode.TXDOWN);
                }
            } else if (localName.equals("source")) {
                if (text.equals("spe")) {
                    currentConfig.getLC().setSource(
                        LocalCoincidenceConfiguration.Source.SPE);
                } else if (text.equals("mpe")) {
                    currentConfig.getLC().setSource(
            ...
            currentConfig.setHardwareMonitorInterval((int) (
                40000000 * Double.parseDouble(text)));
        } else if (localName.equals("fastMonitorInterval")) {
            currentConfig.setFastMonitorInterval((int) (
                40000000 * Double.parseDouble(text)));
